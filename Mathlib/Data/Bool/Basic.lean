...
alias and_not_self := Bool.and_not_self_right
#align bool.band_bnot_self Bool.and_not_self

alias not_and_self := Bool.and_not_self_left
#align bool.bnot_band_self Bool.not_and_self

alias or_not_self := Bool.or_not_self_right
#align bool.bor_bnot_self Bool.or_not_self

alias not_or_self := Bool.or_not_self_left
#align bool.bnot_bor_self Bool.not_or_self

#align bool.bxor_comm Bool.xor_comm

attribute [simp] Bool.xor_assoc
#align bool.bxor_assoc Bool.xor_assoc

#align bool.bxor_left_comm Bool.xor_left_comm

#align bool.bxor_bnot_left Bool.xor_not_self_left

#align bool.bxor_bnot_right Bool.xor_not_self_right
...
attribute [simp] Bool.not_and
#align bool.bnot_band Bool.not_and

attribute [simp] Bool.not_or
...
theorem ofNat_le_ofNat {n m : Nat} (h : n ≤ m) : ofNat n ≤ ofNat m := by
  ...
  | isTrue hn => rw [decide_eq_true hn]; exact Bool.false_le ..
  | isFalse hn =>
    cases Nat.decEq m 0 with
    | isFalse hm => rw [decide_eq_false hm]; exact Bool.le_true ..
